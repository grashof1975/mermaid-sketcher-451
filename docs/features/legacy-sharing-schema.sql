-- 📤 SCHEMA DATABASE CONDIVISIONE DIAGRAMMI
-- Sistema completo per gestione condivisioni, privilegi e inviti
...
-- =============================================================================
CREATE INDEX idx_diagram_shares_diagram_id ON diagram_shares(diagram_id);
CREATE INDEX idx_diagram_shares_shared_with ON diagram_shares(shared_with_id);
CREATE INDEX idx_diagram_shares_status ON diagram_shares(status);
CREATE INDEX idx_public_share_links_token ON public_share_links(share_token);
CREATE INDEX idx_public_share_links_diagram ON public_share_links(diagram_id);
CREATE INDEX idx_sharing_activities_diagram ON sharing_activities(diagram_id);
